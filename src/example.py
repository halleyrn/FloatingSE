...
def example_OC3():
    ...
    # example.shell_mass_factor
    # example.bulkhead_mass_factor
    ...
    example.pretension_percent = 11.173
    ...
    example.number_of_discretizations = 20
    example.spar.stiffener_curve_fit = True #not sure if this is correct
    example.run()
    print '-------------OC3---------------'
    sys_print(example)
